...
def buck2_haskell_test(name: str, srcs = [], *args, extra_compiler_flags: list[str] = [],
    module_prefix: str | None = None, **kwargs):
...
def buck2_haskell_library(name: str, srcs = [], extra_compiler_flags: list[str] = [],
    module_prefix: str | None = None, **kwargs):
